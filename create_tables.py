...
messages_table = 'create table if not exists messages (id integer primary key autoincrement, name text, chat_id integer, "text" text, schedule decimal, foreign key(chat_id) references groups(id))'
